// prepack: copy bundled API reference docs into harmonyos-api-references-mcp/data/ for the npm package.
// Source: ../harmonyos_api_references_docs/*.md + index_log.txt + ../INDEX.md
// Target: ./data/docs/*.md + index_log.txt + INDEX.md
...
const srcDocs = path.join(projectRoot, "harmonyos_api_references_docs");
...
// index_log.txt 在项目根(不在 docs 里), 拷到 data/docs/ 供解析
...
// INDEX.md 放到 data/ 根(非 docs/),供浏览参考
